...
/** Puntero para obtener el valor instantáneo del contador físico del Timer (Sincronización de fase) */
typedef uint32_t (*timer_cnt_get_ptr)(generic_pwm_t ch);
/** @} */
...
typedef struct {
	...
	timer_cnt_get_ptr get_timer_cnt; /**< Abstracción de __HAL_TIM_GET_COUNTER para lectura de CNT físico */
} hal_interface_t;

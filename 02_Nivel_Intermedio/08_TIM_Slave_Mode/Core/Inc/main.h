...
#define TCS_LED_GPIO_Port GPIOF
...
#define TCS_S0_Pin GPIO_PIN_2
#define TCS_S0_GPIO_Port GPIOG
#define TCS_S1_Pin GPIO_PIN_3
#define TCS_S1_GPIO_Port GPIOG
